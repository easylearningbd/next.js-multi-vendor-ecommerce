...
const STROKE: Record<string, Seg[]> = {
  ...
  download: [["path", { d: "M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" }], ["polyline", { points: "14 2 14 8 20 8" }], ["line", { x1: 12, y1: 18, x2: 12, y2: 12 }], ["polyline", { points: "9 15 12 18 15 15" }]],
...
const FILLED: Record<string, Seg[]> = {
  ...
  xTwitter: [["path", { d: "M18.9 2H22l-7.5 8.6L23 22h-6.8l-5-6.6L5.4 22H2.3l8-9.2L1.5 2h6.9l4.5 6z" }]],
};
