...
import type { Option } from "@/lib/admin-product-types";
import { Icon } from "@/components/dashboard/Icon";

// Search (name/SKU/vendor, debounced) + category filter + page size — driven through
// the URL so the server component re-fetches. Shared by all five admin product lists.
export function AdminProductsToolbar({ categories }: { categories: Option[] }) {
  ...
  return (
    <div className="mb-5 flex flex-wrap items-center gap-3.5">
      <div className="flex h-[46px] min-w-[240px] flex-1 items-center overflow-hidden rounded-md border border-line bg-field transition focus-within:border-iris-500 focus-within:shadow-[0_0_0_3px_var(--color-iris-100)]">
