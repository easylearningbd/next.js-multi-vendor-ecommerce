// Shared skeleton for the admin product lists' loading.tsx boundaries.
export function AdminProductsListSkeleton() {
  return (
    <div>
      <div className="mb-5 h-8 w-52 animate-pulse rounded-md bg-line-soft" />
      <div className="rounded-2xl border border-line-soft bg-surface p-[22px_24px] shadow-xs">
        <div className="mb-5 flex gap-3.5">
          ...
          <div className="h-[46px] w-40 animate-pulse rounded-md bg-line-soft" />
        ...
        <div className="overflow-hidden rounded-xl border border-line-soft">
          ...
          {Array.from({ length: 6 }).map((_, i) => (
            <div key={i} className="flex items-center gap-4 border-t border-line-soft p-[14px_18px]">
              <div className="h-[44px] w-[44px] flex-none animate-pulse rounded-lg bg-line-soft" />
              ...
              <div className="h-8 w-20 animate-pulse rounded-md bg-line-soft" />
            </div>
          ))}
        </div>
      </div>
