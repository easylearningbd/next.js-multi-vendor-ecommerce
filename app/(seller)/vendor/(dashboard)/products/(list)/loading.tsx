// Content-area skeleton for the Product List (shown while the server fetches).
export default function ProductListLoading() {
  return (
    <div>
      <div className="mb-5 flex items-center justify-between">
        <div className="h-8 w-44 animate-pulse rounded-md bg-line-soft" />
        <div className="h-[46px] w-44 animate-pulse rounded-md bg-line-soft" />
      </div>
        ...
        <div className="overflow-hidden rounded-xl border border-line-soft">
          ...
          {Array.from({ length: 6 }).map((_, i) => (
            <div key={i} className="flex items-center gap-4 border-t border-line-soft p-[14px_18px]">
              <div className="h-[46px] w-[46px] flex-none animate-pulse rounded-lg bg-line-soft" />
              ...
              <div className="h-6 w-11 animate-pulse rounded-full bg-line-soft" />
