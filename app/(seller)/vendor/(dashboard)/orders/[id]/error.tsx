...
export default function VendorOrderDetailError({ reset }: { error: Error; reset: () => void }) {
  return (
    <div className="flex flex-col items-center rounded-[18px] border border-line-soft bg-surface px-8 py-16 text-center">
      ...
      <div className="font-display text-[20px] font-bold text-ink">Couldn&apos;t load this order</div>
