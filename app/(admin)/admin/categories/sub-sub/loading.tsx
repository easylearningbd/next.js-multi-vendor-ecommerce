// Content-area skeleton for the Sub-Sub-Categories list.
export default function SubSubCategoriesLoading() {
  return (
    <div>
      <div className="mb-5 flex items-center justify-between">
        <div className="h-8 w-60 animate-pulse rounded-md bg-line-soft" />
        <div className="h-[46px] w-52 animate-pulse rounded-md bg-line-soft" />
      </div>
